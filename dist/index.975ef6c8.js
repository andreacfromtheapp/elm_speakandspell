...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$randomWordsApiUrl = 'https://random-words-api.vercel.app/word';
    var $author$project$Main$getNewWordCmd = $elm$http$Http$get({
        ...
        url: $author$project$Main$randomWordsApiUrl
    });
    ...
    var $author$project$Main$isGuessEmtpy = function(model) {
        return $elm$core$String$isEmpty(model.guessWord);
    };
    var $author$project$Main$checkResult = function(model) {
        return $author$project$Main$isGuessEmtpy(model) ? 'AN EMPTY STRING IS NEVER THE ANSWER...' : _Utils_eq(model.guessWord, model.checkWord) ? 'CONGRATULATIONS! ' + (model.guessWord + ' IS CORRECT!') : 'OH NO... ' + (model.guessWord + ' ISN\'T RIGHT...');
    };
    ...
    var $author$project$Main$wordToScreen = function(model) {
        return $author$project$Main$isGuessEmtpy(model) ? _Utils_update(model, {
            output: $author$project$Main$Init
        }) : _Utils_update(model, {
            output: $author$project$Main$Word
        });
    ...
    var $author$project$Main$namePlusSoundCtrl = A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
        ...
        A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
            $mdgriffith$elm_ui$Element$Region$description('Sound Commands')
        ]), _List_fromArray([
