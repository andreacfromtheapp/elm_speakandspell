...
},{"./Main.elm":"jaXzP"}],"jaXzP":[function(require,module,exports) {
(function(scope) {
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$On = {
        $: 'On'
    };
    var $author$project$Main$GetNewWord = function(a) {
        return {
            $: 'GetNewWord',
            a: a
        };
    ...
    var $author$project$Main$NewWord = F3(function(word, definition, pronunciation) {
        return {
    ...
    var $author$project$Main$newWordDecoder = A3($NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required, 'pronunciation', $elm$json$Json$Decode$string, A3($NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required, 'definition', $elm$json$Json$Decode$string, A3($NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required, 'word', $elm$json$Json$Decode$string, $elm$json$Json$Decode$succeed($author$project$Main$NewWord))));
    var $author$project$Main$randomWordApiUrl = 'https://random-words-api.vercel.app/word';
    var $author$project$Main$getNewWordCmd = $elm$http$Http$get({
        expect: A2($elm$http$Http$expectJson, $author$project$Main$GetNewWord, $elm$json$Json$Decode$list($author$project$Main$newWordDecoder)),
        url: $author$project$Main$randomWordApiUrl
    });
    var $author$project$Main$init = function(flags) {
        return _Utils_Tuple2({
            ...
            output: $author$project$Main$Init,
            placeholder: '',
            result: '',
            sound: $author$project$Main$On,
            status: $author$project$Main$Loading,
            viewport: {
                height: flags.win_height,
                width: flags.win_width
            }
        }, $author$project$Main$getNewWordCmd);
    };
    ...
    var $Gizra$elm_keyboard_event$Keyboard$Event$KeyboardEvent = F7(function(altKey, ctrlKey, key, keyCode, metaKey, repeat, shiftKey) {
        return {
            altKey: altKey,
            ctrlKey: ctrlKey,
            key: key,
    ...
    var $Gizra$elm_keyboard_event$Keyboard$Event$decodeKey = $elm$json$Json$Decode$maybe(A2($elm$json$Json$Decode$andThen, function(key) {
        return $elm$core$String$isEmpty(key) ? $elm$json$Json$Decode$fail('empty key') : $elm$json$Json$Decode$succeed(key);
    }, A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string)));
    var $Gizra$elm_keyboard_event$Keyboard$Event$decodeNonZero = A2($elm$json$Json$Decode$andThen, function(code) {
        return !code ? $elm$json$Json$Decode$fail('code was zero') : $elm$json$Json$Decode$succeed(code);
    }, $elm$json$Json$Decode$int);
    var $Gizra$elm_keyboard_event$Keyboard$Event$decodeKeyCode = $elm$json$Json$Decode$oneOf(_List_fromArray([
    ...
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$A = {
        $: 'A'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Add = {
        $: 'Add'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Alt = {
        $: 'Alt'
    };
    ...
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$B = {
        $: 'B'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Backspace = {
        $: 'Backspace'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$C = {
        $: 'C'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$CapsLock = {
        $: 'CapsLock'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$ChromeSearch = {
        $: 'ChromeSearch'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Command = {
        $: 'Command'
    };
    ...
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$D = {
        $: 'D'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Decimal = {
        $: 'Decimal'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Delete = {
        $: 'Delete'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Divide = {
        $: 'Divide'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Down = {
        $: 'Down'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$E = {
        $: 'E'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Eight = {
        $: 'Eight'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$End = {
        $: 'End'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Enter = {
        $: 'Enter'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Escape = {
        $: 'Escape'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F = {
        $: 'F'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F1 = {
        $: 'F1'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F10 = {
        $: 'F10'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F11 = {
        $: 'F11'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F12 = {
        $: 'F12'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F2 = {
        $: 'F2'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F3 = {
        $: 'F3'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F4 = {
        $: 'F4'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F5 = {
        $: 'F5'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F6 = {
        $: 'F6'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F7 = {
        $: 'F7'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F8 = {
        $: 'F8'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$F9 = {
        $: 'F9'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Five = {
        $: 'Five'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Four = {
        $: 'Four'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$G = {
        $: 'G'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$H = {
        $: 'H'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Home = {
        $: 'Home'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$I = {
        $: 'I'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Insert = {
        $: 'Insert'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$J = {
        $: 'J'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$K = {
        $: 'K'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$L = {
        $: 'L'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Left = {
        $: 'Left'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$M = {
        $: 'M'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Multiply = {
        $: 'Multiply'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$N = {
        $: 'N'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Nine = {
        $: 'Nine'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$NumLock = {
        $: 'NumLock'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$NumpadEight = {
        $: 'NumpadEight'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$NumpadFive = {
        $: 'NumpadFive'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$NumpadFour = {
        $: 'NumpadFour'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$NumpadNine = {
        $: 'NumpadNine'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$NumpadOne = {
        $: 'NumpadOne'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$NumpadSeven = {
        $: 'NumpadSeven'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$NumpadSix = {
        $: 'NumpadSix'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$NumpadThree = {
        $: 'NumpadThree'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$NumpadTwo = {
        $: 'NumpadTwo'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$NumpadZero = {
        $: 'NumpadZero'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$O = {
        $: 'O'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$One = {
        $: 'One'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$P = {
        $: 'P'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$PageDown = {
        $: 'PageDown'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$PageUp = {
        $: 'PageUp'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$PauseBreak = {
        $: 'PauseBreak'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$PrintScreen = {
        $: 'PrintScreen'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Q = {
        $: 'Q'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$R = {
        $: 'R'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Right = {
        $: 'Right'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$S = {
        $: 'S'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$ScrollLock = {
        $: 'ScrollLock'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Seven = {
        $: 'Seven'
    };
    ...
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Six = {
        $: 'Six'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Spacebar = {
        $: 'Spacebar'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Subtract = {
        $: 'Subtract'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$T = {
        $: 'T'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Tab = {
        $: 'Tab'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Three = {
        $: 'Three'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Two = {
        $: 'Two'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$U = {
        $: 'U'
    };
    ...
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Up = {
        $: 'Up'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$V = {
        $: 'V'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$W = {
        $: 'W'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Windows = {
        $: 'Windows'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$X = {
        $: 'X'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Y = {
        $: 'Y'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Z = {
        $: 'Z'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$Zero = {
        $: 'Zero'
    };
    var $SwiftsNamesake$proper_keyboard$Keyboard$Key$fromCode = function(keyCode) {
        switch(keyCode){
            ...
            case 91:
                return $SwiftsNamesake$proper_keyboard$Keyboard$Key$Ambiguous(_List_fromArray([
                    $SwiftsNamesake$proper_keyboard$Keyboard$Key$Windows,
                    $SwiftsNamesake$proper_keyboard$Keyboard$Key$Command,
                    $SwiftsNamesake$proper_keyboard$Keyboard$Key$ChromeSearch
                ]));
            case 96:
    ...
    var $author$project$Main$onKeyDownSub = $elm$browser$Browser$Events$onKeyDown(A2($elm$json$Json$Decode$map, $author$project$Main$KeyPressed, $Gizra$elm_keyboard_event$Keyboard$Event$decodeKeyboardEvent));
    ...
    var $author$project$Main$windowResizeSub = $elm$browser$Browser$Events$onResize($author$project$Main$OnResize);
    var $author$project$Main$subscriptions = function(_v0) {
        return $elm$core$Platform$Sub$batch(_List_fromArray([
            $author$project$Main$windowResizeSub,
            $author$project$Main$onKeyDownSub
        ]));
    };
    ...
    var $author$project$Main$Word = {
        $: 'Word'
    };
    var $elm$core$String$append = _String_append;
    var $author$project$Main$appendToGuessWord = F2(function(model, string) {
        return _Utils_update(model, {
            guessWord: A2($elm$core$String$append, model.guessWord, string),
            output: $author$project$Main$Word
        });
    });
    var $author$project$Main$checkResult = function(model) {
        return $elm$core$String$isEmpty(model.guessWord) ? 'AN EMPTY STRING IS NEVER THE ANSWER...' : _Utils_eq(model.guessWord, model.checkWord) ? 'CONGRATULATIONS! ' + (model.guessWord + ' IS CORRECT!') : 'OH NO... ' + (model.guessWord + ' ISN\'T RIGHT...');
    };
    var $elm$core$String$dropRight = F2(function(n, string) {
        return n < 1 ? string : A3($elm$core$String$slice, 0, -n, string);
    });
    var $author$project$Main$eraseLetter = function(model) {
        return _Utils_update(model, {
            guessWord: A2($elm$core$String$dropRight, 1, model.guessWord),
            output: $author$project$Main$Word,
            result: ''
        });
    };
    var $author$project$Main$isGuessEmtpy = function(model) {
        return $elm$core$String$isEmpty(model.guessWord) ? true : false;
    };
    var $author$project$Main$Off = {
        $: 'Off'
    };
    var $author$project$Main$isStringEmpty = function(string) {
        return $elm$core$String$isEmpty(string) ? true : false;
    };
    var $elm$core$String$toUpper = _String_toUpper;
    var $author$project$Main$kbdEventToString = function(event) {
        var _v0 = event.key;
        if (_v0.$ === 'Just') {
            var key = _v0.a;
            return A2($elm$core$String$all, $elm$core$Char$isAlpha, key) && $elm$core$String$length(key) === 1 ? $elm$core$String$toUpper(key) : '';
        } else return '';
    };
    var $author$project$Main$resetWord = function(model) {
        return _Utils_update(model, {
            guessWord: '',
            output: $author$project$Main$Init,
            result: ''
    ...
    var $author$project$Main$sound = _Platform_outgoingPort('sound', $elm$json$Json$Encode$bool);
    var $author$project$Main$setSound = function(_switch) {
        if (_switch.$ === 'On') return $author$project$Main$sound(true);
        else return $author$project$Main$sound(false);
    };
    var $author$project$Main$speak = _Platform_outgoingPort('speak', $elm$json$Json$Encode$string);
    var $author$project$Main$spell = _Platform_outgoingPort('spell', $elm$json$Json$Encode$list($elm$json$Json$Encode$string));
    var $author$project$Main$splitToSpell = function(word) {
        return A2($elm$core$String$split, '', word);
    };
    var $author$project$Main$Result = {
        $: 'Result'
    };
    var $author$project$Main$submitWord = function(model) {
        return _Utils_update(model, {
            output: $author$project$Main$Result,
            result: $author$project$Main$checkResult(model)
        });
    };
    var $elm$core$String$toLower = _String_toLower;
    var $author$project$Main$wordToScreen = function(model) {
        return $elm$core$String$isEmpty(model.guessWord) ? _Utils_update(model, {
            output: $author$project$Main$Init
        }) : _Utils_update(model, {
            output: $author$project$Main$Word
        });
    };
    var $author$project$Main$wordToSpeak = function(model) {
        return $elm$core$String$toLower(model.guessWord);
    };
    var $author$project$Main$kbdEventToCommand = F2(function(event, model) {
        if (event.altKey || event.ctrlKey || event.metaKey || event.repeat || event.shiftKey) return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
        else {
            var _v0 = event.key;
            _v0$9: while(true){
                if (_v0.$ === 'Just') switch(_v0.a){
                    case '2':
                        return _Utils_Tuple2(model, $author$project$Main$setSound($author$project$Main$On));
                    case '3':
                        return _Utils_Tuple2(model, $author$project$Main$setSound($author$project$Main$Off));
                    case '5':
                        return _Utils_Tuple2($author$project$Main$resetWord(model), $elm$core$Platform$Cmd$none);
                    case '6':
                        return _Utils_Tuple2($author$project$Main$resetWord(model), $elm$core$Platform$Cmd$none);
                    case '8':
                        return _Utils_Tuple2($author$project$Main$wordToScreen(model), $author$project$Main$speak($author$project$Main$wordToSpeak(model)));
                    case '9':
                        return _Utils_Tuple2($author$project$Main$wordToScreen(model), $author$project$Main$spell($author$project$Main$splitToSpell($author$project$Main$wordToSpeak(model))));
                    case '0':
                        return _Utils_Tuple2($author$project$Main$resetWord(model), $author$project$Main$getNewWordCmd);
                    case 'Backspace':
                        return _Utils_Tuple2($author$project$Main$isGuessEmtpy($author$project$Main$eraseLetter(model)) ? $author$project$Main$resetWord(model) : $author$project$Main$eraseLetter(model), $elm$core$Platform$Cmd$none);
                    case 'Enter':
                        return _Utils_Tuple2($author$project$Main$submitWord(model), $author$project$Main$speak($author$project$Main$checkResult(model)));
                    default:
                        break _v0$9;
                }
                else break _v0$9;
            }
            return _Utils_Tuple2($author$project$Main$isStringEmpty($author$project$Main$kbdEventToString(event)) ? model : A2($author$project$Main$appendToGuessWord, model, $author$project$Main$kbdEventToString(event)), $author$project$Main$speak($elm$core$String$toLower($author$project$Main$kbdEventToString(event))));
        }
    });
    var $author$project$Main$setCheckWord = function(wordsList) {
        return $elm$core$String$toUpper(wordsList.word);
    };
    ...
    var $author$project$Main$setPlaceHolder = function(wordsList) {
        return A2($elm$core$String$repeat, $elm$core$String$length(wordsList.word), '_ ');
    };
    ...
    var $author$project$Main$unwrapNewWordList = function(wordsList) {
        var _v0 = $elm$core$List$head(wordsList);
        if (_v0.$ === 'Just') {
            var word = _v0.a;
            return word;
        } else return {
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        switch(msg.$){
            ...
            case 'GetNewWord':
                if (msg.a.$ === 'Ok') {
                    var word = msg.a.a;
                    if (word.b) return _Utils_Tuple2(_Utils_update(model, {
                        checkWord: $author$project$Main$setCheckWord($author$project$Main$unwrapNewWordList(word)),
                        placeholder: $author$project$Main$setPlaceHolder($author$project$Main$unwrapNewWordList(word)),
                        status: $author$project$Main$Loaded($author$project$Main$unwrapNewWordList(word))
                    }), $elm$core$Platform$Cmd$none);
                    else return _Utils_Tuple2(_Utils_update(model, {
                        status: $author$project$Main$Errored($elm$http$Http$BadBody('No words found :('))
                    }), $elm$core$Platform$Cmd$none);
                } else {
                    var err = msg.a.a;
                    return _Utils_Tuple2(_Utils_update(model, {
                        status: $author$project$Main$Errored(err)
                    }), $elm$core$Platform$Cmd$none);
                }
            case 'KeyPressed':
                var event = msg.a;
                return A2($author$project$Main$kbdEventToCommand, event, model);
            case 'KeyClicked':
                var string = msg.a;
                return _Utils_Tuple2(A2($author$project$Main$appendToGuessWord, model, string), $author$project$Main$speak($elm$core$String$toLower(string)));
            case 'GetAnotherWord':
                return _Utils_Tuple2($author$project$Main$resetWord(model), $author$project$Main$getNewWordCmd);
            case 'EraseLetter':
                return _Utils_Tuple2($author$project$Main$isGuessEmtpy($author$project$Main$eraseLetter(model)) ? $author$project$Main$resetWord(model) : $author$project$Main$eraseLetter(model), $elm$core$Platform$Cmd$none);
            ...
            case 'SetSound':
                var param = msg.a;
                return _Utils_Tuple2(model, $author$project$Main$setSound(param));
            case 'Speak':
                return _Utils_Tuple2($author$project$Main$wordToScreen(model), $author$project$Main$speak($author$project$Main$wordToSpeak(model)));
            default:
                return _Utils_Tuple2($author$project$Main$wordToScreen(model), $author$project$Main$spell($author$project$Main$splitToSpell($author$project$Main$wordToSpeak(model))));
    ...
    var $author$project$Main$errorToString = function(error) {
        switch(error.$){
            ...
            case 'Timeout':
                return 'Unable to reach the server, try again later';
            case 'NetworkError':
    ...
    var $mdgriffith$elm_ui$Element$Lazy$embed = function(x) {
        switch(x.$){
            ...
            case 'Styled':
                var styled = x.a;
                return styled.html(A2($mdgriffith$elm_ui$Internal$Model$OnlyDynamic, {
                    focus: {
                        backgroundColor: $elm$core$Maybe$Nothing,
                        borderColor: $elm$core$Maybe$Nothing,
            ...
            case 'Text':
                var text = x.a;
                return $elm$core$Basics$always($elm$virtual_dom$VirtualDom$text(text));
            default:
                return $elm$core$Basics$always($elm$virtual_dom$VirtualDom$text(''));
        }
    };
    var $mdgriffith$elm_ui$Element$Lazy$apply1 = F2(function(fn, a) {
        return $mdgriffith$elm_ui$Element$Lazy$embed(fn(a));
    });
    var $mdgriffith$elm_ui$Element$Lazy$lazy = F2(function(fn, a) {
        return $mdgriffith$elm_ui$Internal$Model$Unstyled(A3($elm$virtual_dom$VirtualDom$lazy3, $mdgriffith$elm_ui$Element$Lazy$apply1, fn, a));
    });
    var $mdgriffith$elm_ui$Internal$Model$Monospace = {
        $: 'Monospace'
    };
    ...
    var $author$project$Main$elmLogoBlue = A2($elm$svg$Svg$svg, _List_fromArray([
        $elm$svg$Svg$Attributes$id('SvgjsSvg1001'),
        $elm$svg$Svg$Attributes$width('96'),
        $elm$svg$Svg$Attributes$height('96'),
        $elm$svg$Svg$Attributes$version('1.1')
    ]), _List_fromArray([
        A2($elm$svg$Svg$defs, _List_fromArray([
            $elm$svg$Svg$Attributes$id('SvgjsDefs1002')
        ]), _List_Nil),
        A2($elm$svg$Svg$g, _List_fromArray([
            $elm$svg$Svg$Attributes$id('SvgjsG1008'),
            ...
            A2($elm$svg$Svg$svg, _List_fromArray([
                ...
                A2($elm$svg$Svg$rect, _List_fromArray([
                    ...
                    $elm$svg$Svg$Attributes$fill('#2da6ef'),
                    $elm$svg$Svg$Attributes$transform('rotate(45.001 246.83 161.471)'),
                    $elm$svg$Svg$Attributes$class('color7FD13B svgShape')
                ]), _List_Nil),
                A2($elm$svg$Svg$polygon, _List_fromArray([
                    $elm$svg$Svg$Attributes$fill('#2da6ef'),
                    $elm$svg$Svg$Attributes$points('323.298 143.724 323.298 0 179.573 0'),
                    $elm$svg$Svg$Attributes$class('color60B5CC svgShape')
                ]), _List_Nil),
                A2($elm$svg$Svg$polygon, _List_fromArray([
                    $elm$svg$Svg$Attributes$fill('#2da6ef'),
                    $elm$svg$Svg$Attributes$points('152.781 161.649 0 8.868 0 314.432'),
                    $elm$svg$Svg$Attributes$class('color5A6378 svgShape')
                ]), _List_Nil),
                A2($elm$svg$Svg$polygon, _List_fromArray([
                    $elm$svg$Svg$Attributes$fill('#2da6ef'),
    ...
    var $mdgriffith$elm_ui$Element$Font$glow = F2(function(clr, i) {
        var shade = {
            blur: i * 2,
            color: clr,
            offset: _Utils_Tuple2(0, 0)
        };
        return A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$txtShadows, A3($mdgriffith$elm_ui$Internal$Model$Single, $mdgriffith$elm_ui$Internal$Model$textShadowClass(shade), 'text-shadow', $mdgriffith$elm_ui$Internal$Model$formatTextShadow(shade)));
    });
    ...
    var $mdgriffith$elm_ui$Element$rgba255 = F4(function(red, green, blue, a) {
        return A4($mdgriffith$elm_ui$Internal$Model$Rgba, red / 255, green / 255, blue / 255, a);
    });
    var $mdgriffith$elm_ui$Internal$Model$Serif = {
        $: 'Serif'
    };
    ...
    var $author$project$Main$speakAndSpellName = A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
        $mdgriffith$elm_ui$Element$Region$description('App Name'),
        $mdgriffith$elm_ui$Element$Font$family(_List_fromArray([
            $mdgriffith$elm_ui$Element$Font$typeface('LiberationSerifBold'),
        ...
        A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$Font$color(A4($mdgriffith$elm_ui$Element$rgba255, 209, 24, 6, 0.84)),
            $mdgriffith$elm_ui$Element$alignLeft
        ]), A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$text, 'Speak')),
        A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$Font$color(A3($mdgriffith$elm_ui$Element$rgb255, 255, 234, 240)),
            A2($mdgriffith$elm_ui$Element$Font$glow, A3($mdgriffith$elm_ui$Element$rgb255, 45, 166, 239), 1),
            $mdgriffith$elm_ui$Element$alignLeft
        ]), A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$text, '&')),
        A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$Font$color(A4($mdgriffith$elm_ui$Element$rgba255, 45, 90, 232, 0.84)),
            $mdgriffith$elm_ui$Element$alignLeft
        ]), A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$text, 'Spell'))
    ]));
    var $author$project$Main$namePlusLogo = A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
        ...
        A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
            $mdgriffith$elm_ui$Element$Region$description('App name and Elm logo')
        ]), _List_fromArray([
            $author$project$Main$speakAndSpellName
        ])),
        A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$html, $author$project$Main$elmLogoBlue)
    ]));
    ...
    var $author$project$Main$viewErrored = function(errorMessage) {
        return A2($author$project$Main$yellowShell, $author$project$Main$namePlusLogo, A2($mdgriffith$elm_ui$Element$wrappedRow, _List_fromArray([
            $mdgriffith$elm_ui$Element$Region$description('Error Screen'),
            $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 250, 10, 40, 1)),
            $mdgriffith$elm_ui$Element$Border$color(A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 20, 1)),
            $mdgriffith$elm_ui$Element$Border$width(1),
            $mdgriffith$elm_ui$Element$Border$solid,
            $mdgriffith$elm_ui$Element$Border$rounded(10),
            $mdgriffith$elm_ui$Element$Font$family(_List_fromArray([
                $mdgriffith$elm_ui$Element$Font$typeface('LiberationMonoRegular'),
                $mdgriffith$elm_ui$Element$Font$monospace
            ])),
            $mdgriffith$elm_ui$Element$Font$color(A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
            ...
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$Region$description('Error Message')
            ]), A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$text, 'Error: ' + $author$project$Main$errorToString(errorMessage)))
        ])));
    };
    var $author$project$Main$SetSound = function(a) {
        return {
            $: 'SetSound',
            a: a
        };
    ...
    var $author$project$Main$commandBtn = F4(function(bgColor, alignment, pressAction, labelText) {
        return A2($mdgriffith$elm_ui$Element$Input$button, _List_fromArray([
            $mdgriffith$elm_ui$Element$Region$description('Command ' + labelText),
            ...
            $mdgriffith$elm_ui$Element$mouseOver(_List_fromArray([
                $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 201, 68, 16, 1)),
                $mdgriffith$elm_ui$Element$Font$color(A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255))
            ])),
            ...
            label: A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$text, labelText),
            onPress: $elm$core$Maybe$Just(pressAction)
        });
    });
    var $author$project$Main$blueCommandBtn = F2(function(pressAction, labelText) {
        return A4($author$project$Main$commandBtn, A4($mdgriffith$elm_ui$Element$rgba255, 45, 166, 239, 1), $mdgriffith$elm_ui$Element$alignRight, pressAction, labelText);
    });
    var $author$project$Main$namePlusSoundCtrl = A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
        $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
        $mdgriffith$elm_ui$Element$paddingEach({
            bottom: 0,
            left: 0,
        ...
        A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
            $mdgriffith$elm_ui$Element$Region$description('Bottom Commands')
        ]), _List_fromArray([
            A2($author$project$Main$blueCommandBtn, $author$project$Main$SetSound($author$project$Main$Off), 'SOUND OFF [3]'),
            A2($author$project$Main$blueCommandBtn, $author$project$Main$SetSound($author$project$Main$On), 'SOUND ON [2]')
        ]))
    ]));
    var $author$project$Main$GetAnotherWord = {
        $: 'GetAnotherWord'
    };
    ...
    var $author$project$Main$newWordScreen = function(newWord) {
        return _List_fromArray([
            A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
                $mdgriffith$elm_ui$Element$Region$description('New Word Screen'),
                $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
                $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 20, 153, 223, 1)),
                $mdgriffith$elm_ui$Element$Border$color(A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 1)),
                ...
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$Region$description('New Word'),
                    $mdgriffith$elm_ui$Element$centerY
                ]), A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$text, 'Your word is: ' + $elm$core$String$toUpper(newWord.word))),
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$Region$description('Word Definition'),
                    $mdgriffith$elm_ui$Element$centerY
                ]), A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$text, 'Definition: ' + newWord.definition)),
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$Region$description('Word Pronunciation'),
                    $mdgriffith$elm_ui$Element$centerY
                ]), A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$text, 'Pronunciation: ' + newWord.pronunciation))
            ])),
            A2($mdgriffith$elm_ui$Element$Input$button, _List_fromArray([
                $mdgriffith$elm_ui$Element$Region$description('Command NEW WORD [0]'),
                $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
                $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 20, 153, 223, 1)),
                $mdgriffith$elm_ui$Element$Border$color(A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 1)),
                $mdgriffith$elm_ui$Element$Border$width(1),
                ...
                $mdgriffith$elm_ui$Element$mouseOver(_List_fromArray([
                    $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 200, 153, 223, 1)),
                    $mdgriffith$elm_ui$Element$Font$color(A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255))
                ])),
                $mdgriffith$elm_ui$Element$focused(_List_fromArray([
                    $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 200, 153, 223, 1)),
                ...
                label: $mdgriffith$elm_ui$Element$text('NEW WORD [0]'),
                onPress: $elm$core$Maybe$Just($author$project$Main$GetAnotherWord)
            })
        ]);
    };
    var $author$project$Main$elmLogoGrayish = A2($elm$svg$Svg$svg, _List_fromArray([
        $elm$svg$Svg$Attributes$id('SvgjsSvg1001'),
        ...
        A2($elm$svg$Svg$g, _List_fromArray([
            ...
            A2($elm$svg$Svg$svg, _List_fromArray([
                ...
                A2($elm$svg$Svg$svg, _List_fromArray([
                    ...
                    A2($elm$svg$Svg$polygon, _List_fromArray([
                        $elm$svg$Svg$Attributes$fill('#787159'),
                        $elm$svg$Svg$Attributes$points('161.649 152.782 231.514 82.916 91.783 82.916'),
                        $elm$svg$Svg$Attributes$class('colorF0AD00 svgShape color2da6ef')
                    ]), _List_Nil),
                    A2($elm$svg$Svg$polygon, _List_fromArray([
                        $elm$svg$Svg$Attributes$fill('#787159'),
                        $elm$svg$Svg$Attributes$points('8.867 0 79.241 70.375 232.213 70.375 161.838 0'),
                        $elm$svg$Svg$Attributes$class('color7FD13B svgShape color2da6ef')
                    ]), _List_Nil),
                    A2($elm$svg$Svg$rect, _List_fromArray([
                        $elm$svg$Svg$Attributes$width('107.676'),
                        $elm$svg$Svg$Attributes$height('108.167'),
                    ...
                    A2($elm$svg$Svg$polygon, _List_fromArray([
                        $elm$svg$Svg$Attributes$fill('#787159'),
                        $elm$svg$Svg$Attributes$points('323.298 143.724 323.298 0 179.573 0'),
                        $elm$svg$Svg$Attributes$class('color60B5CC svgShape color2da6ef')
                    ]), _List_Nil),
                    A2($elm$svg$Svg$polygon, _List_fromArray([
                        $elm$svg$Svg$Attributes$fill('#787159'),
                        $elm$svg$Svg$Attributes$points('152.781 161.649 0 8.868 0 314.432'),
                        $elm$svg$Svg$Attributes$class('color5A6378 svgShape color2da6ef')
                    ]), _List_Nil),
                    A2($elm$svg$Svg$polygon, _List_fromArray([
                        $elm$svg$Svg$Attributes$fill('#787159'),
                        $elm$svg$Svg$Attributes$points('255.522 246.655 323.298 314.432 323.298 178.879'),
    ...
    var $author$project$Main$outputText = function(model) {
        ...
        switch(_v0.$){
            case 'Init':
                return 'START TYPING TO MATCH THE WORD ABOVE';
            case 'Holder':
                return model.placeholder;
            case 'Word':
                return model.guessWord;
            default:
                return model.result;
        }
    };
    var $author$project$Main$outputScreen = function(model) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            $mdgriffith$elm_ui$Element$Region$description('Output Screen'),
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
            $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 1))
        ]), _List_fromArray([
            A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
                $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                $mdgriffith$elm_ui$Element$Font$family(_List_fromArray([
                    $mdgriffith$elm_ui$Element$Font$typeface('LCD14'),
                    $mdgriffith$elm_ui$Element$Font$monospace
                ])),
                $mdgriffith$elm_ui$Element$Font$color(A4($mdgriffith$elm_ui$Element$rgba255, 110, 200, 120, 0.8)),
                $mdgriffith$elm_ui$Element$Font$size(32),
                $mdgriffith$elm_ui$Element$padding(55)
            ]), _List_fromArray([
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$Region$description('Output Text'),
                    $mdgriffith$elm_ui$Element$centerX,
                    $mdgriffith$elm_ui$Element$centerY,
                    $mdgriffith$elm_ui$Element$paddingEach({
                        bottom: 0,
                ...
                ]), A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$text, $author$project$Main$outputText(model)))
            ])),
            A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
                $mdgriffith$elm_ui$Element$Region$description('Elm branding'),
                $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                ...
                $mdgriffith$elm_ui$Element$Font$bold,
                $mdgriffith$elm_ui$Element$Font$color(A4($mdgriffith$elm_ui$Element$rgba255, 120, 113, 89, 1)),
                $mdgriffith$elm_ui$Element$Font$size(20),
                $mdgriffith$elm_ui$Element$paddingEach({
                    bottom: 20,
                    left: 50,
                ...
                A2($mdgriffith$elm_ui$Element$newTabLink, _List_fromArray([
                    ...
                    label: A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$text, 'Elm Instruments'),
                    url: 'https://elm-lang.org/'
                }),
                A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
                    $mdgriffith$elm_ui$Element$alignRight
                ]), _List_fromArray([
                    A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$html, $author$project$Main$elmLogoGrayish)
                ]))
            ]))
        ]));
    };
    var $author$project$Main$EraseLetter = {
        $: 'EraseLetter'
    };
    var $author$project$Main$ResetWord = {
        $: 'ResetWord'
    };
    var $author$project$Main$Speak = {
        $: 'Speak'
    };
    var $author$project$Main$Spell = {
        $: 'Spell'
    };
    var $author$project$Main$SubmitWord = {
        $: 'SubmitWord'
    };
    var $author$project$Main$KeyClicked = function(a) {
        return {
            $: 'KeyClicked',
            a: a
        };
    ...
    var $author$project$Main$codeToString = function(asciiCode) {
        return $elm$core$String$fromChar($elm$core$Char$fromCode(asciiCode));
    };
    var $author$project$Main$alphabetRow = F2(function(start, end) {
        return A2($elm$core$List$map, function(asciiCode) {
            return A2($mdgriffith$elm_ui$Element$Input$button, _List_fromArray([
                $mdgriffith$elm_ui$Element$Region$description('Keyboard Key ' + $author$project$Main$codeToString(asciiCode)),
                $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 253, 116, 6, 1)),
                $mdgriffith$elm_ui$Element$Border$color(A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 20, 1)),
                $mdgriffith$elm_ui$Element$Border$width(1),
                $mdgriffith$elm_ui$Element$Border$solid,
                $mdgriffith$elm_ui$Element$Border$rounded(10),
                ...
                label: A2($mdgriffith$elm_ui$Element$Lazy$lazy, $mdgriffith$elm_ui$Element$text, $author$project$Main$codeToString(asciiCode)),
                onPress: $elm$core$Maybe$Just($author$project$Main$KeyClicked($author$project$Main$codeToString(asciiCode)))
            });
    ...
    var $author$project$Main$yellowCommandBtn = F2(function(pressAction, labelText) {
        return A4($author$project$Main$commandBtn, A4($mdgriffith$elm_ui$Element$rgba255, 250, 175, 0, 1), $mdgriffith$elm_ui$Element$alignLeft, pressAction, labelText);
    });
    var $author$project$Main$theKeyboard = A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
        $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
        $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 20, 153, 223, 1)),
        $mdgriffith$elm_ui$Element$Border$color(A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 20, 1)),
        $mdgriffith$elm_ui$Element$Border$width(1),
        ...
        A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
            $mdgriffith$elm_ui$Element$Region$description('Top Keyboard Row from A to M'),
            A2($mdgriffith$elm_ui$Element$spacingXY, 10, 0),
            $mdgriffith$elm_ui$Element$centerY,
            $mdgriffith$elm_ui$Element$centerX
        ]), A2($author$project$Main$alphabetRow, 65, 77)),
        A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
            $mdgriffith$elm_ui$Element$Region$description('Bottom Keyboard Row from N to Z'),
            A2($mdgriffith$elm_ui$Element$spacingXY, 10, 0),
            $mdgriffith$elm_ui$Element$centerY,
            $mdgriffith$elm_ui$Element$centerX
        ]), A2($author$project$Main$alphabetRow, 78, 90)),
        A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
            $mdgriffith$elm_ui$Element$Region$description('Keyboard Commands'),
            A2($mdgriffith$elm_ui$Element$spacingXY, 14, 0),
            $mdgriffith$elm_ui$Element$centerY,
            $mdgriffith$elm_ui$Element$centerX
        ]), _List_fromArray([
            A2($author$project$Main$yellowCommandBtn, $author$project$Main$EraseLetter, 'ERASE LETTER [↤]'),
            A2($author$project$Main$yellowCommandBtn, $author$project$Main$ResetWord, 'RESET [5]'),
            A2($author$project$Main$yellowCommandBtn, $author$project$Main$Speak, 'SPEAK [8]'),
            A2($author$project$Main$yellowCommandBtn, $author$project$Main$Spell, 'SPELL [9]'),
            A2($author$project$Main$yellowCommandBtn, $author$project$Main$SubmitWord, 'SUBMIT [↵]'),
            A2($author$project$Main$yellowCommandBtn, $author$project$Main$ResetWord, 'RETRY [6]')
        ]))
    ]));
    var $author$project$Main$viewLoaded = F2(function(newWord, model) {
        return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
            ...
            A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
                $mdgriffith$elm_ui$Element$Region$description('Loaded App'),
                $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 251, 50, 0, 1)),
                $mdgriffith$elm_ui$Element$Border$roundEach({
                    bottomLeft: 80,
                    bottomRight: 80,
                    topLeft: 40,
                ...
                ]), $author$project$Main$newWordScreen(newWord)),
                $author$project$Main$outputScreen(model),
                A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
                    $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                    $mdgriffith$elm_ui$Element$paddingEach({
                        bottom: 130,
                    ...
                    A2($author$project$Main$yellowShell, $author$project$Main$namePlusSoundCtrl, $author$project$Main$theKeyboard)
                ]))
            ]))
        ]));
    });
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$joinWith = function(f) {
        return A2($elm$core$Basics$composeR, $elm$core$List$map(f), $elm$core$String$concat);
    };
    var $elm$core$Set$fromList = function(list) {
        return A3($elm$core$List$foldl, $elm$core$Set$insert, $elm$core$Set$empty, list);
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$escapedChars_ = $elm$core$Set$fromList(_List_fromArray([
        _Utils_chr('.'),
        _Utils_chr(' '),
        _Utils_chr(','),
        _Utils_chr('#'),
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Transform$rounded = F2(function(n, val) {
        return $elm$core$String$fromInt($elm$core$Basics$round(val) * n);
    });
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$rounded = F2(function(n, val) {
        return $elm$core$String$fromInt($elm$core$Basics$round(val * n));
    });
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$name = function(prop) {
        switch(prop.$){
            ...
            default:
                var n = prop.a;
                var p = prop.b;
                return _Utils_ap($andrewMacmurray$elm_simple_animation$Internal$Animation$Property$escape(n), $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$escape(p));
        }
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$frameName = function(_v0) {
        var dur = _v0.a;
        var props = _v0.b;
        return 'f' + ($elm$core$String$fromInt($elm$core$Basics$round(dur)) + A2($andrewMacmurray$elm_simple_animation$Internal$Animation$joinWith, $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$name, props));
    };
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Ease$toString = function(e) {
        switch(e.$){
            case 'Cubic':
                ...
                var c = e.c;
                var d = e.d;
                return 'cubic-bezier(' + (A2($elm$core$String$join, ',', _List_fromArray([
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$optionName = function(o) {
        switch(o.$){
            ...
            case 'Ease':
                var ease = o.a;
                return $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$escape($andrewMacmurray$elm_simple_animation$Internal$Ease$toString(ease));
            case 'Iteration':
                var i = o.a;
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$name_ = function(anim) {
        return $andrewMacmurray$elm_simple_animation$Internal$Animation$isEmpty(anim) ? 'anim-empty' : 'anim-' + ($elm$core$String$fromInt($andrewMacmurray$elm_simple_animation$Internal$Animation$duration_(anim)) + ($andrewMacmurray$elm_simple_animation$Internal$Animation$optionNames($andrewMacmurray$elm_simple_animation$Internal$Animation$rawOptions_(anim)) + $andrewMacmurray$elm_simple_animation$Internal$Animation$framesNames($andrewMacmurray$elm_simple_animation$Internal$Animation$frames_(anim))));
    };
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$animationDuration = function(anim) {
        return $andrewMacmurray$elm_simple_animation$Internal$Unit$ms($andrewMacmurray$elm_simple_animation$Internal$Animation$duration_(anim));
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$collectOption = F2(function(o, opts) {
        switch(o.$){
            case 'Delay':
                var ms = o.a;
                return _Utils_update(opts, {
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$defaults = {
        delay: $elm$core$Maybe$Nothing,
        isYoyo: false,
        iteration: $elm$core$Maybe$Nothing,
        reversed: false,
        timingFunction: $elm$core$Maybe$Nothing
    };
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Loop = {
        $: 'Loop'
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$iterationForYoyo = function(opts) {
        ...
        } else return $andrewMacmurray$elm_simple_animation$Internal$Animation$Count(2);
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$normalise = function(opts) {
        return opts.isYoyo ? _Utils_update(opts, {
            iteration: $elm$core$Maybe$Just($andrewMacmurray$elm_simple_animation$Internal$Animation$iterationForYoyo(opts))
        }) : opts;
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$options_ = A2($elm$core$Basics$composeR, $andrewMacmurray$elm_simple_animation$Internal$Animation$rawOptions_, A2($elm$core$Basics$composeR, A2($elm$core$List$foldl, $andrewMacmurray$elm_simple_animation$Internal$Animation$collectOption, $andrewMacmurray$elm_simple_animation$Internal$Animation$defaults), $andrewMacmurray$elm_simple_animation$Internal$Animation$normalise));
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$renderOption = F2(function(name, toProp) {
        return $elm$core$Maybe$map(function(x) {
            return name + (': ' + toProp(x));
        });
    });
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$AlternateReverse_ = {
        $: 'AlternateReverse_'
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Alternate_ = {
        $: 'Alternate_'
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Reverse_ = {
        $: 'Reverse_'
    };
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$renderOptions_ = function(opts) {
        return _List_fromArray([
            ...
            A3($andrewMacmurray$elm_simple_animation$Internal$Animation$renderOption, 'animation-direction', $andrewMacmurray$elm_simple_animation$Internal$Animation$renderDirection, $andrewMacmurray$elm_simple_animation$Internal$Animation$toDirection(opts))
        ]);
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$renderOptions = A2($elm$core$Basics$composeR, $andrewMacmurray$elm_simple_animation$Internal$Animation$options_, A2($elm$core$Basics$composeR, $andrewMacmurray$elm_simple_animation$Internal$Animation$renderOptions_, $elm$core$List$filterMap($elm$core$Basics$identity)));
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$getProp = function(f) {
        return A2($elm$core$Basics$composeR, $elm$core$List$filterMap(f), $elm$core$List$head);
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$opacity_ = function(p) {
        if (p.$ === 'Opacity') {
            var n = p.a;
            return $elm$core$Maybe$Just('opacity:' + $elm$core$String$fromFloat(n));
        } else return $elm$core$Maybe$Nothing;
    };
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$collectTransforms = A2($elm$core$List$foldl, F2(function(val, acc) {
        if (val.$ === 'Transform') {
            var t = val.a;
            return A2($elm$core$List$cons, t, acc);
        } else return acc;
    }), _List_Nil);
    var $andrewMacmurray$elm_simple_animation$Internal$Transform$combine = F2(function(transform, combined) {
        switch(transform.$){
            case 'Rotate':
                var n = transform.a;
                return _Utils_update(combined, {
            ...
            case 'ScaleXY':
                ...
                var y_ = transform.b;
                return _Utils_update(combined, {
                    scale: $elm$core$Maybe$Just(_Utils_Tuple2(x_, y_))
                });
            default:
                switch(transform.a.$){
                    case 'XY':
                        ...
                        var y_ = _v1.b;
                        return _Utils_update(combined, {
                            xy: $elm$core$Maybe$Just(_Utils_Tuple2(x_, y_))
                        });
                    case 'X':
                        var n = transform.a.a;
                        return _Utils_update(combined, {
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Transform$empty = {
        rotate: $elm$core$Maybe$Nothing,
        scale: $elm$core$Maybe$Nothing,
        x: $elm$core$Maybe$Nothing,
        xy: $elm$core$Maybe$Nothing,
        y: $elm$core$Maybe$Nothing
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Transform$render_ = function(f) {
        return A2($elm$core$Basics$composeR, $elm$core$Maybe$map(f), $elm$core$Maybe$withDefault(''));
    };
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Transform$rotate_ = function(n) {
        return $andrewMacmurray$elm_simple_animation$Internal$Transform$join(_List_fromArray([
            'rotate(',
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Transform$render = function(combined) {
        return A2($elm$core$String$join, ' ', A2($elm$core$List$filter, A2($elm$core$Basics$composeR, $elm$core$String$isEmpty, $elm$core$Basics$not), _List_fromArray([
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Transform$toString = A2($elm$core$Basics$composeR, A2($elm$core$List$foldl, $andrewMacmurray$elm_simple_animation$Internal$Transform$combine, $andrewMacmurray$elm_simple_animation$Internal$Transform$empty), $andrewMacmurray$elm_simple_animation$Internal$Transform$render);
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$transform_ = function(props) {
        ...
        if (!_v0.b) return $elm$core$Maybe$Nothing;
            ...
            var transforms = _v0;
            return $elm$core$Maybe$Just('transform:' + $andrewMacmurray$elm_simple_animation$Internal$Transform$toString(transforms));
        }
    };
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$render = function(props) {
        return A2($elm$core$String$join, ';', $andrewMacmurray$elm_simple_animation$Internal$Animation$Property$filterMaybes($elm$core$List$concat(_List_fromArray([
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$keyframes_ = A2($elm$core$Basics$composeR, $andrewMacmurray$elm_simple_animation$Internal$Animation$frames_, A2($elm$core$Basics$composeR, $elm$core$List$map($andrewMacmurray$elm_simple_animation$Internal$Animation$renderFrame), $elm$core$String$join('\n')));
    ...
    var $andrewMacmurray$elm_simple_animation$Simple$Animation$Animated$toStylesheet_ = function(anim) {
        return A3($elm$html$Html$node, 'style', _List_Nil, _List_fromArray([
            $elm$html$Html$text($andrewMacmurray$elm_simple_animation$Internal$Animation$stylesheet_(anim))
        ]));
    };
    var $andrewMacmurray$elm_simple_animation$Simple$Animation$Animated$ui = F5(function(options, node_, anim, attrs, els) {
        return A2(node_, A2($elm$core$List$append, _List_fromArray([
            options.behindContent(options.html($andrewMacmurray$elm_simple_animation$Simple$Animation$Animated$toStylesheet_(anim))),
            options.htmlAttribute($elm$html$Html$Attributes$class($andrewMacmurray$elm_simple_animation$Internal$Animation$name_(anim)))
        ]), attrs), els);
    });
    var $author$project$Main$animatedUi = $andrewMacmurray$elm_simple_animation$Simple$Animation$Animated$ui({
        behindContent: $mdgriffith$elm_ui$Element$behindContent,
        html: $mdgriffith$elm_ui$Element$html,
        htmlAttribute: $mdgriffith$elm_ui$Element$htmlAttribute
    });
    var $author$project$Main$animatedEl = $author$project$Main$animatedUi($mdgriffith$elm_ui$Element$el);
    var $author$project$Main$animatedLetter = F2(function(animation, element) {
        return A3($author$project$Main$animatedEl, animation, _List_Nil, element);
    });
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Ease$Cubic = F4(function(a, b, c, d) {
        return {
            $: 'Cubic',
            a: a,
            b: b,
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Ease$easeOutBack = A4($andrewMacmurray$elm_simple_animation$Internal$Ease$Cubic, 0.34, 1.56, 0.64, 1);
    var $andrewMacmurray$elm_simple_animation$Simple$Animation$easeOutBack = $andrewMacmurray$elm_simple_animation$Internal$Animation$Ease($andrewMacmurray$elm_simple_animation$Internal$Ease$easeOutBack);
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Reverse = {
        $: 'Reverse'
    };
    var $andrewMacmurray$elm_simple_animation$Simple$Animation$reverse = $andrewMacmurray$elm_simple_animation$Internal$Animation$Reverse;
    var $andrewMacmurray$elm_simple_animation$Simple$Animation$Step = F2(function(a, b) {
        return {
            $: 'Step',
            a: a,
            b: b
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Animation = F3(function(a, b, c) {
        return {
            $: 'Animation',
            a: a,
            b: b,
    ...
    var $andrewMacmurray$elm_simple_animation$Internal$Animation$Frame = F2(function(a, b) {
        return {
            $: 'Frame',
            a: a,
            b: b
    ...
    var $andrewMacmurray$elm_simple_animation$Simple$Animation$adjustCompleteWait = F2(function(anim, timePassed) {
    ...
    var $andrewMacmurray$elm_simple_animation$Simple$Animation$accumDuration = F2(function(step_, curr) {
        switch(step_.$){
            case 'Step':
                var d = step_.a;
                return d + curr;
    ...
    var $andrewMacmurray$elm_simple_animation$Simple$Animation$toFrames = F2(function(firstFrame, steps_) {
        var percentPerMs = 100 / $andrewMacmurray$elm_simple_animation$Simple$Animation$totalDuration(steps_);
        var getFrame = F2(function(f, _v2) {
            var n = _v2.a;
            var xs = _v2.b;
            var cur = _v2.c;
            switch(f.$){
                case 'Step':
                    var d = f.a;
                    var props = f.b;
                    return _Utils_Tuple3(n + d, _Utils_ap(xs, _List_fromArray([
                        cur
                ...
                case 'Wait':
                    ...
                    return _Utils_Tuple3(n + d, _Utils_ap(xs, _List_fromArray([
                        cur
                    ])), A2($andrewMacmurray$elm_simple_animation$Internal$Animation$Frame, percentPerMs * (n + d), $andrewMacmurray$elm_simple_animation$Simple$Animation$frameProps(cur)));
                default:
                    var d = f.a;
                    var dur = A2($andrewMacmurray$elm_simple_animation$Simple$Animation$adjustCompleteWait, d, n);
                    return _Utils_Tuple3(dur, _Utils_ap(xs, _List_fromArray([
                        cur
                    ])), A2($andrewMacmurray$elm_simple_animation$Internal$Animation$Frame, percentPerMs * dur, $andrewMacmurray$elm_simple_animation$Simple$Animation$frameProps(cur)));
            }
        });
        return (function(_v0) {
            var xs = _v0.b;
            var curr = _v0.c;
            return _Utils_ap(xs, _List_fromArray([
                curr
            ]));
        })(A3($elm$core$List$foldl, getFrame, _Utils_Tuple3(0, _List_Nil, A2($andrewMacmurray$elm_simple_animation$Internal$Animation$Frame, 0, firstFrame)), steps_));
    });
    var $andrewMacmurray$elm_simple_animation$Simple$Animation$toAnimation = function(_v0) {
        var s = _v0.a;
        return A3($andrewMacmurray$elm_simple_animation$Internal$Animation$Animation, $andrewMacmurray$elm_simple_animation$Simple$Animation$totalDuration(s.steps), s.options, A2($andrewMacmurray$elm_simple_animation$Simple$Animation$toFrames, s.startAt, s.steps));
    };
    var $andrewMacmurray$elm_simple_animation$Simple$Animation$steps = F2(function(_v0, steps_) {
        var options = _v0.options;
        var startAt = _v0.startAt;
        return $andrewMacmurray$elm_simple_animation$Simple$Animation$toAnimation($andrewMacmurray$elm_simple_animation$Simple$Animation$Stepped({
            options: options,
            startAt: startAt,
            steps: steps_
        }));
    ...
    var $author$project$Main$hoverAnimationDown = A2($andrewMacmurray$elm_simple_animation$Simple$Animation$steps, {
        options: _List_fromArray([
            $andrewMacmurray$elm_simple_animation$Simple$Animation$loop,
            $andrewMacmurray$elm_simple_animation$Simple$Animation$reverse,
            $andrewMacmurray$elm_simple_animation$Simple$Animation$easeOutBack
        ]),
        startAt: _List_fromArray([
            $andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(8)
        ])
    }, _List_fromArray([
        A2($andrewMacmurray$elm_simple_animation$Simple$Animation$step, 640, _List_fromArray([
            $andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(0)
        ])),
        A2($andrewMacmurray$elm_simple_animation$Simple$Animation$step, 400, _List_fromArray([
            $andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(8)
        ]))
    ]));
    var $andrewMacmurray$elm_simple_animation$Internal$Ease$easeInBack = A4($andrewMacmurray$elm_simple_animation$Internal$Ease$Cubic, 0.36, 0, 0.66, -0.56);
    var $andrewMacmurray$elm_simple_animation$Simple$Animation$easeInBack = $andrewMacmurray$elm_simple_animation$Internal$Animation$Ease($andrewMacmurray$elm_simple_animation$Internal$Ease$easeInBack);
    ...
    var $author$project$Main$hoverAnimationRotate = A2($andrewMacmurray$elm_simple_animation$Simple$Animation$steps, {
        options: _List_fromArray([
            $andrewMacmurray$elm_simple_animation$Simple$Animation$loop,
            $andrewMacmurray$elm_simple_animation$Simple$Animation$easeInBack
        ]),
        startAt: _List_fromArray([
        ...
        A2($andrewMacmurray$elm_simple_animation$Simple$Animation$step, 400, _List_fromArray([
            $andrewMacmurray$elm_simple_animation$Simple$Animation$Property$rotate(10)
        ])),
        A2($andrewMacmurray$elm_simple_animation$Simple$Animation$step, 640, _List_fromArray([
            $andrewMacmurray$elm_simple_animation$Simple$Animation$Property$rotate(90)
        ]))
    ]));
    var $author$project$Main$hoverAnimationUp = A2($andrewMacmurray$elm_simple_animation$Simple$Animation$steps, {
        options: _List_fromArray([
            $andrewMacmurray$elm_simple_animation$Simple$Animation$loop,
            $andrewMacmurray$elm_simple_animation$Simple$Animation$easeInBack
        ]),
    ...
    var $author$project$Main$loadingLetter = function(labelText) {
        return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 250, 175, 0, 1)),
            $mdgriffith$elm_ui$Element$Border$color(A4($mdgriffith$elm_ui$Element$rgba255, 253, 116, 6, 1)),
            $mdgriffith$elm_ui$Element$Border$width(8),
            $mdgriffith$elm_ui$Element$Border$solid,
            $mdgriffith$elm_ui$Element$Border$rounded(12),
            $mdgriffith$elm_ui$Element$Font$family(_List_fromArray([
                $mdgriffith$elm_ui$Element$Font$typeface('LiberationMonoBold'),
                $mdgriffith$elm_ui$Element$Font$monospace
            ])),
            $mdgriffith$elm_ui$Element$Font$size(32),
    ...
    var $author$project$Main$viewLoading = A2($author$project$Main$yellowShell, $author$project$Main$namePlusLogo, A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
        $mdgriffith$elm_ui$Element$Region$description('Loading Screen'),
        $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
        $mdgriffith$elm_ui$Element$Background$color(A4($mdgriffith$elm_ui$Element$rgba255, 20, 153, 223, 1)),
        $mdgriffith$elm_ui$Element$Border$color(A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 20, 1)),
        $mdgriffith$elm_ui$Element$Border$width(1),
        ...
        A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
            $mdgriffith$elm_ui$Element$Region$description('Loading animation'),
            $mdgriffith$elm_ui$Element$spacing(10)
        ]), _List_fromArray([
            A2($author$project$Main$animatedLetter, $author$project$Main$hoverAnimationUp, A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Main$loadingLetter, 'L')),
            A2($author$project$Main$animatedLetter, $author$project$Main$hoverAnimationDown, A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Main$loadingLetter, 'O')),
            A2($author$project$Main$animatedLetter, $author$project$Main$hoverAnimationUp, A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Main$loadingLetter, 'A')),
            A2($author$project$Main$animatedLetter, $author$project$Main$hoverAnimationDown, A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Main$loadingLetter, 'D')),
            A2($author$project$Main$animatedLetter, $author$project$Main$hoverAnimationUp, A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Main$loadingLetter, 'I')),
            A2($author$project$Main$animatedLetter, $author$project$Main$hoverAnimationDown, A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Main$loadingLetter, 'N')),
            A2($author$project$Main$animatedLetter, $author$project$Main$hoverAnimationUp, A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Main$loadingLetter, 'G')),
            A2($author$project$Main$animatedLetter, $author$project$Main$hoverAnimationRotate, A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Main$loadingLetter, '.')),
            A2($author$project$Main$animatedLetter, $author$project$Main$hoverAnimationRotate, A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Main$loadingLetter, '.')),
            A2($author$project$Main$animatedLetter, $author$project$Main$hoverAnimationRotate, A2($mdgriffith$elm_ui$Element$Lazy$lazy, $author$project$Main$loadingLetter, '.'))
        ]))
    ])));
    var $author$project$Main$view = function(model) {
        return A2($mdgriffith$elm_ui$Element$layout, _List_fromArray([
            ...
            switch(_v0.$){
                ...
                case 'Loaded':
                    var word = _v0.a;
                    return A2($author$project$Main$viewLoaded, word, model);
                default:
                    var errorMessage = _v0.a;
                    return $author$project$Main$viewErrored(errorMessage);
            }
        }());
    };
            ...
            'init': $author$project$Main$main(A2($elm$json$Json$Decode$andThen, function(win_width) {
                ...
                "types": {
                    ...
                    "aliases": {
                        ...
                        "Main.NewWord": {
                            "args": [],
                            "type": "{ word : String.String, definition : String.String, pronunciation : String.String }"
                        }
                    },
                    "unions": {
                        "Main.Msg": {
...
},{}]},["j1F46","hD4hw"], "hD4hw", "parcelRequire8452")
